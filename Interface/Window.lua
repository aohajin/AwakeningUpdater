...
function AUP:CreateWindow(name, exitable, movable, resizable)
    ...
    if exitable then
        window:AddButton(
            "Interface\\Addons\\AwakeningUpdater\\Media\\Textures\\ExitCross.tga",
            function()
                window:Hide()
            end
        )
    ...
    if resizable then
        ...
        window.resizeFrame.tex:SetTexture("Interface\\Addons\\AwakeningUpdater\\Media\\Textures\\ResizeTriangle.tga")
